		...
		>
			...
			<div className="flex justify-between mb-2">
				...
				<span className="font-semibold">
					<AnimatedCounter value={userStats.openIssues} duration={3} />
				</span>
			</div>
			<div className="flex justify-between mb-2">
			...
			<div className="w-full bg-gray-700 rounded-full h-2.5 mt-2 flex">
				<div
					...
					style={{
						width: `${userStats.closedIssues / (userStats.openIssues + userStats.closedIssues) > 0 ? (userStats.closedIssues / (userStats.openIssues + userStats.closedIssues)) * 100 : 0}%`,
					}}
				></div>
				<div
					className="bg-red-600 h-2.5 rounded-r-full"
					style={{
						width: `${userStats.openIssues / (userStats.openIssues + userStats.closedIssues) > 0 ? (userStats.openIssues / (userStats.openIssues + userStats.closedIssues)) * 100 : 0}%`,
					}}
				></div>
			</div>

	...
	return (
		<div className="relative w-32 h-32 flex items-center justify-center">
			...
			<div className="text-center z-10">
				...
				<div className="text-[10px] uppercase tracking-widest text-[#fbbf24] font-bold">
					Day Streak
				</div>
			</div>
		</div>
...
export function StatsContent({userStats}: {userStats: UserStats}) {
	...
	if (isLoading) {
		return (
			<div className="w-full h-full flex items-center justify-center text-white">
				<div className="animate-pulse text-2xl font-light tracking-[0.5em]">
					INITIALIZING...
				</div>
			</div>
		);
	...
	const totalBytes = userStats.topLanguages.reduce(
	...
	return (
		<div className="w-full h-full flex flex-col items-center justify-center text-white p-12 overflow-hidden">
			{/* Header */}
			<div className="w-full text-center mb-10" style={fadeInAndSlideUp(frame)}>
			...
			<div className="w-full max-w-6xl grid gap-8 grid-cols-12">
				...
				<div className="col-span-4 space-y-6">
					<GlassCard className="p-6 h-full" style={fadeInAndSlideUp(frame, 35)}>
						<h2 className="text-lg font-bold mb-6 text-gray-200 border-b border-white/10 pb-2">
							ISSUE TRACKING
						</h2>
						...
						<div className="space-y-6">
							<div>
								<div className="flex justify-between text-sm mb-1 text-gray-400">
									...
									<span className="text-white font-mono">
										<AnimatedCounter value={userStats.closedIssues} />
									</span>
								</div>
							...
							<div>
								<div className="flex justify-between text-sm mb-1 text-gray-400">
									...
									<span className="text-white font-mono">
										<AnimatedCounter value={userStats.openIssues} />
									</span>
								</div>
								<div className="w-full bg-white/5 rounded-full h-1.5">
									<div
				...
				<div className="col-span-4 space-y-6">
					<GlassCard
						...
						style={fadeInAndSlideUp(frame, 40)}
					>
						<h2 className="text-lg font-bold mb-4 text-gray-200 w-full text-center border-b border-white/10 pb-2">
							COMMIT STREAK
						</h2>
				...
				<div className="col-span-4 space-y-6">
					<GlassCard className="p-6 h-full" style={fadeInAndSlideUp(frame, 45)}>
						<h2 className="text-lg font-bold mb-4 text-gray-200 border-b border-white/10 pb-2">
							CODE METRICS
						</h2>
